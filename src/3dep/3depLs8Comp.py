...
with open(os.path.join(r"C:\Users\Kjslo\Documents\local_dev\dynamic_lands_lab\frontend\public\terrain", "HayesvilleKS_ct.csv"), mode='w', newline='', encoding='utf-8') as file:
