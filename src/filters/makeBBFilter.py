...
from spatial_utils import haversine, mpolygon_yeild_pts, polygon_filter, complete_bbox
######################################################################################
#polygon_filter(lon, lat, polygon)

pt1 = (30.81274170806273, -105.09995637901189)
pt2 = (30.820090998176493, -105.08193101490613)
bb = complete_bbox(pt1, pt2)
print(bb)
######################################################################################
